...
export class AdministraPeriodosComponent implements OnInit {
  ...
  columns = [
            { name: 'Centro Costo' ,prop:'CentroMateriales.CentroCosto'}, 
            { name: 'Descripcion',prop: 'CentroMateriales.Descripcion'}, 
            { name: 'Periodo', prop:this.getPeriodo('Periodo') }, 
            { name: 'Acciones' , prop:'Identificador'}];
