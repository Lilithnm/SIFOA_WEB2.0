...
@Component({
  selector: 'solicitudes-historial-tabla',
  //encapsulation: ViewEncapsulation.None,
  templateUrl: './solicitudes-historial.component.html',
  styleUrls: ['./solicitudes-historial.component.scss'],
})
...
this.svcSpinner.hide()
  ...
  obtenerSolicitudes(){
    ...
    this.svcSpinner.show();
      this.svcSolicitud.ObtenerHistorico(nuevaSolicitud).subscribe(respuesta => {
          this.svcSpinner.hide();          
          this.data = respuesta;
  ...
  procesaSolicitud(){
    ...
    function insuficente(material:SolicitudMaterialesModel) {
      return material.EstatusMaterial.Identificador ==3;
    }
