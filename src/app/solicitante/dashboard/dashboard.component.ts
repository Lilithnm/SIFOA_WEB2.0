...
export class DashboardComponent implements OnInit {
  ...
  constructor( private svcMedia: MediaService) {
    ...
    if(this.periodo == 0){
      this.periodoDesc = "CERRADO";
      this.clasePeriodo="card l-bg-red p-2 px-4 text-white py-3";
    }else{      
      this.periodoDesc = "ABIERTO";
      this.clasePeriodo="card l-bg-green p-2 px-4 text-white py-3";
    }
  ...
  downloadFile(){
    ...
    this.svcMedia.descargaCalendario().subscribe((response: { url: string; }) => {
